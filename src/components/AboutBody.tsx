...
function AboutBody() {
  return (
    <div>
        ...
        <div className='100vw  h-[100vh] flex justify-evenly items-center'>
              
              <div className=' relative w-1/5 h-3/5 rounded-lg overflow-hidden'>
              ...
              <div className=' w-3/6 p-8'>
                  ...
                  <p className='text-center text-xl font-sans  sm:text-xl text-muted-foreground p-3' >NIC Ice Creams came to life over late-night cravings and endless laughter because, let’s face it, the best memories are made with a spoon in hand. We wanted ice cream that’s as honest as your best friend, no artificial flavors, no preservatives, just pure goodness. So, we got to work, turning the creamiest milk and freshest fruits into flavours inspired by all the things we love.
